# zoetrop — round5 (Refinement line — current-state foundation snapshot) Package

> **Purpose.** Outbound package for round5: the input to a design roundtrip via claude.ai/design.
