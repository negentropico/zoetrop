# zoetrop — round6 (Refinement line — current-state foundation snapshot) Package

> **Purpose.** Outbound package for round6: the input to a design roundtrip via claude.ai/design.
