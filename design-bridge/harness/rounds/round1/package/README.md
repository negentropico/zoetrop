# zoetrop — round1 (ZOETROP-R1 charter — design language, IA spine, calm-instrument screen system (foundation)) Package

> **Purpose.** Outbound package for round1: the input to a design roundtrip via claude.ai/design.
