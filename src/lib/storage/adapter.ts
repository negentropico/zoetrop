 ...
 *
 * Defines the contract for metric persistence.
 * Implementations: LocalStorageAdapter (Phase 1-4), PostgresAdapter (Phase 5+)
 */

import type { Metric, MetricCategory, SyncStatus } from '@/types/metrics';
