...
export async function loader({ request, params }: Route.LoaderArgs) {
  ...
  // T-05-DOC / Gate 3: assertSubjectAccess — 403 for cross-tenant docId OR
  // unassigned practitioner (AUTH-03 CR-01). This is the raw byte route — the
  // highest PHI-density artifact — so per-assignment access MUST be enforced
  // here, not only on the viewer page. Gate 3 fires only for practitioners
  // (assignedIds undefined for owners → Gate 3 skipped).
