// Zoetrope brand mark: Fibonacci (φ) logarithmic spiral
...
interface SpiralMarkProps {
  ...
  color?: string; // default "var(--ink)" — uses CSS var so dark remap works
}
