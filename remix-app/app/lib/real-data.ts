...
// WHOOP Biometrics - Monthly averages
export const realAutonomicData: Metric[] = [
  // August 2025 (best month)
  {
    id: "autonomic-hrv-aug25",
    name: "HRV (RMSSD)",
    value: 43,
    unit: "ms",
    category: "autonomic",
  ...
  // January 2026 (current - cessation acute phase)
  {
    id: "autonomic-hrv-jan26",
    name: "HRV (RMSSD)",
    value: 33.7,
    unit: "ms",
    category: "autonomic",
