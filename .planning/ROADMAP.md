...
- [ ] 01-01-PLAN.md — Install + configure the Vitest harness (deps, scripts, vite.config test block; empty run exits 0; package legitimacy gate)
...
|-------|----------------|--------|-----------|
| 1. Schema Baseline + Engine Tests + Auth Spike | 0/5 | Planned | - |
