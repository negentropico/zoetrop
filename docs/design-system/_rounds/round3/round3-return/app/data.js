...
window.ZD = {
  ...
  metrics: {
    vitamins: [
      { id: 'vitd', name: 'Vitamin D (25-OH)', value: 58, unit: 'ng/mL', status: 'optimal',    opt: [50, 80], ref: [30, 100], min: 0,   max: 120, history: [{date:'Oct',value:31},{date:'Nov',value:33},{date:'Jan',value:34},{date:'Feb',value:38},{date:'Mar',value:41},{date:'May',value:47},{date:'Jun',value:52},{date:'Sep',value:58}] },
    ...
    autonomic: [
      { id: 'hrv',    name: 'HRV (rMSSD)',       value:68, unit:'ms',    status:'optimal',     opt:[60,110],  ref:[20,100],  min:15, max:130, history:[{date:'Oct',value:46},{date:'Nov',value:49},{date:'Dec',value:48},{date:'Jan',value:52},{date:'Feb',value:55},{date:'Mar',value:58},{date:'Apr',value:60},{date:'May',value:62},{date:'Jun',value:63},{date:'Jul',value:65},{date:'Aug',value:66},{date:'Sep',value:68}] },
  ...
  /* --- per-version supplement stacks (compare screen) ------- */
  versionStacks: {
    P0: [],
    P1: [
      { name: 'Vitamin D3 + K2', dose: '5000 IU / 200 mcg' },
      { name: 'Magnesium Glycinate', dose: '400 mg' },
      { name: 'Omega-3 (EPA+DHA)', dose: '3 g' },
      { name: 'Zinc Bisglycinate', dose: '30 mg' },
    ],
    P2: [
      { name: 'Vitamin D3 + K2', dose: '5000 IU / 200 mcg' },
      { name: 'Magnesium Glycinate', dose: '400 mg' },
      { name: 'Omega-3 (EPA+DHA)', dose: '3 g' },
      { name: 'Zinc Bisglycinate', dose: '30 mg' },
      { name: 'Methylfolate (5-MTHF)', dose: '1 mg' },
    ...
    P3: [
      ...
      { name: 'Vitamin C (buffered)', dose: '1 g' },
    ],
    P4: [
      { name: 'Vitamin D3 + K2', dose: '5000 IU / 200 mcg' },
      { name: 'Magnesium Glycinate', dose: '600 mg' },
      { name: 'Omega-3 (EPA+DHA)', dose: '3 g' },
      { name: 'Zinc Bisglycinate', dose: '30 mg' },
      { name: 'Methylfolate (5-MTHF)', dose: '1 mg' },
      { name: 'Creatine Monohydrate', dose: '5 g' },
      { name: 'Vitamin C (buffered)', dose: '1 g' },
      { name: 'Boron', dose: '3 mg' },
    ],
  },
